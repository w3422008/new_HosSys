...
<body>
    ...
    <div class="wrap">
        <!-- ログインフォーム -->
        <form method="post" action="<?php echo APP_PATH; ?>Controllers/home/home.php" autocomplete=" off">
            <div class="err"></div>
            <label for="uid">ID</label>
            <div class="input-wrapper">
                <input id="uid" type="text" name="user_id" inputmode="ascii" required>
                <span class="input-icon input-icon-user"></span>
            </div>
            <label for="pw">パスワード</label>
            <div class="input-wrapper">
                <input id="pw" type="password" name="password" inputmode="ascii" required>
            ...
            <div class="tab" data-key="recent">
                <span class="tab-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="18"
                        height="18"><!--!Font Awesome Free v7.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        <path
